...
namespace ClientConsole.JCDLibrary {
    ...
    public interface IVelibsRetriever {
        ...
        ClientConsole.JCDLibrary.Station[] getListStationFromCity(string city, string station, string fidelity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVelibsRetriever/getListStationFromCity", ReplyAction="http://tempuri.org/IVelibsRetriever/getListStationFromCityResponse")]
        System.Threading.Tasks.Task<ClientConsole.JCDLibrary.Station[]> getListStationFromCityAsync(string city, string station, string fidelity);
    ...
    public partial class VelibsRetrieverClient : System.ServiceModel.ClientBase<ClientConsole.JCDLibrary.IVelibsRetriever>, ClientConsole.JCDLibrary.IVelibsRetriever {
        ...
        public ClientConsole.JCDLibrary.Station[] getListStationFromCity(string city, string station, string fidelity) {
            return base.Channel.getListStationFromCity(city, station, fidelity);
        }
        
        public System.Threading.Tasks.Task<ClientConsole.JCDLibrary.Station[]> getListStationFromCityAsync(string city, string station, string fidelity) {
